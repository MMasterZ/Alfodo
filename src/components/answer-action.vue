  ...
  >
    <q-card class="transparent shadow-0">
      <q-card-section class="no-padding">
        <!-- #region Desktop -->
        <div style="padding-top:100px;" v-if="!isMobile">
          <div
            align="center"
          ...
          >
            ...
            <div
              class="fit row q-pb-md"
              style="padding-top:35px;"
            >

              <div class="col-1 q-pl-md" style="width:260px;" align="left">
                <div style="margin-top:-100px;">
                  <q-img width="260px" :src="soundAndMonster" no-spinner no-transition />
                </div>
              </div>
                ...
                <div style="width: 100%">
                  ...
                  <div v-else>
                    ...
                    <div v-else>
                      ...
                      <div>
                        <span class="text-bold f32" v-if="practiceData.isCorrectAnswer">
                          Correct</span
                        >
                        <span
                    ...
                    >
                      <span
                        :style="
                          practiceData.isCorrectAnswer ? 'color: #014DA4' : 'color:#EC0B1B;'
                        "
              ...
              <div
                :class="$q.platform.is.desktop ? '' : 'col-12 q-pt-lg'"
                :style="$q.platform.is.desktop ? '' : 'width:100%'"
                :align="$q.platform.is.desktop ? 'right' : 'center'"
                class="q-pa-xs q-px-lg col-12"
              >
        ...
        <!-- #region Mobile -->
        <div style="padding-top:200px;" v-if="isMobile">
          <div
            align="center"
            class="mobile relative-position"
            :class="practiceData.isCorrectAnswer ? 'bg-correct' : 'bg-incorrect'"
          >

          <div class="absolute-top" style="top:-110px;width:150px;" align="left">
            <q-img width="100%" :src="soundAndMonster" no-spinner no-transition />
          </div>

            <div
              class="fit row q-pa-md q-pt-lg"
            >
              <!-- #region Icon ถูก-ผิด -->
              <div
                class="col-1 self-start" style="margin-top:10px;"
              >
                <q-icon
                  size="30px"
                  style="color: #58CC02"
              ...
              >
                <div style="width: 100%">
                  <!-- #region Phonics Only -->
                  <div v-if="practiceStore.skill == 'Phonics'" class="f1f6 text-bold">
                    <div class="f24 text-bold">
                      <div v-if="practiceData.isCorrectAnswer">Excellent!</div>
                    ...
                    <div v-else class="q-mt-sm">
                      <div v-if="!practiceData.isCorrectAnswer">
                        <span
                          ...
                          v-html="practiceData.currentChoice"
                        ></span>
                        <span class="q-ml-md text-bold">เป็นคำตอบที่ผิด</span>
                      </div>
                      <div class="q-mt-sm">
                        <span
...
const soundAndMonster = computed(() => {
  ...
  if (props.practiceData.isCorrectAnswer) {
    imagefile = skill + "-correct";
    systemStore.playEffectCorrect();
  } else {
    imagefile = skill + "-incorrect";
  ...
  if (props.practiceData.isSendAnswer) {
    showMonster = `/images/monster_main/${imagefile}.gif`;
  }
