  ...
  <div class="relative-position row justify-center bg-content-answer">
    ...
    >
      <q-img
        ...
        width="200px"
        :src="`/images/matching/btn-matching-${
          checkAnswerList ? '' : 'not'
        }active.png`"
      ></q-img>
      ...
      <q-img
        ...
        width="200px"
        src="/images/next-question-btn.png"
      ></q-img>
...
<script>
import themeAnimation from "../matching/theme-animation.vue";
...
.bg-sky {
  background-image: url("/images/matching/bg-sky.png");
  background-size: cover;
  background-position: top;
}

.bg-content-answer {
  background-image: url("/images/matching/bg-content-matching.png");
