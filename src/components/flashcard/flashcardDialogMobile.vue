    ...
    >
      <q-card class="shadow-0">
        <q-card-section class="no-padding">
          <div class="box-dialog q-pa-md">
            <div class="row">
              <div class="col self-center">
                <span
                  ><span style="font-size: 24px; line-height: 0">
                    {{ vocabDataList[currentFlashcardIndex].vocab }}
                  </span>
                  <span class="relative-position q-mx-sm" style="font-size: 12px"
                    >({{
        ...
        <q-card-actions align="center">
          <q-btn label="back" @click="showFlashcardDetails = false"></q-btn>
        </q-card-actions>
      </q-card>
    </q-dialog>
  </div>
