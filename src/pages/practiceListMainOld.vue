<template>
  <q-page class="full-height" :class="{ row: $q.platform.is.desktop }">
        ...
        <div class="row relative-position">
          ...
          <div class="col self-center">
            <q-img
              ...
              width="40px"
              src="/images/practicelist/previous-list-btn.png"
            ></q-img>
          </div>
            ...
            <div class="row box-content-practicelist q-py-sm q-px-md">
              ...
              >
                <q-select
                  ...
                  outlined=""
                  @update:modelValue="
                    (val) => $emit('courseChanged', val.courseId)
                  "
                />
              </div>
            </div>
          ...
          <div class="col self-center" align="center">
            <q-img
              ...
              class="cursor-pointer"
              width="40px"
              src="/images/practicelist/next-list-btn.png"
            ></q-img>
          </div>
        </div>
      </div>
      ...
      >
        <div class="self-center col" align="center">
          <q-img
            ...
            src="/images/practicelist/bg-map-theme-1.png"
    ...
    >
      <q-card class="bg-mobile-practice shadow-0">
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const getCourse = async (uid) => {
      try {
        let course = await studentHooks.getallcourse(uid);
        let allLevel = await practiceHooks.level();
        course.forEach(async (element) => {
          levelList.value.push({
            label:
              "ระดับ" +
              allLevel.filter((x) => x.level == element.level)[0].level,
    ...
    const showPassedPracticeCounter = (practiceListId) => {
      let result = practiceLog.value.filter(
    ...
    const showIconPractice = (type) => {
      let nameImage = "/images/practicelist/action-btn-star0.png";
      if (
        type == "flashcard" ||
        type == "grammarlesson" ||
        type == "phonicslesson" ||
        ...
        nameImage = "/images/practicelist/teaching-btn-default.png";
      } else if (type == "matching") {
        nameImage = "/images/practicelist/matching-btn-star0.png";
      } else if (type.includes("multiplechoices")) {
        nameImage = "/images/practicelist/multiple-btn-star0.png";
      } else if (type == "clozetest") {
        nameImage = "/images/practicelist/writing-btn-star0.png";
      }
...
<style scoped>
.bg-mobile-practice {
  background-image: url("/images/practicelist/bg-map-theme-1.png");
...
.bg-practice-main {
  background-image: url("/images/practicelist/bg-practicelist.png");
}
